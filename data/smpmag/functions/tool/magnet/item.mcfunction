...
execute as @e[tag=smpmag.magnetCanAttract.item] at @s if entity @a[predicate=smpmag:tool/magnet/have-active_attract_item,sort=nearest,limit=1,tag=!ThisMagnetUser] run tag @s remove smpmag.magnetCanAttract.item
