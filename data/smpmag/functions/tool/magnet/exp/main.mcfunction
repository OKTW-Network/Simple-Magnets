...
execute if entity @s[predicate=smpmag:tool/magnet/have-active_mk1_attract_exp,predicate=!smpmag:tool/magnet/have-active_mk2_attract_exp] run tag @e[distance=..3,type=experience_orb] add smpmag.magnetCanAttract.exp
execute if entity @s[predicate=smpmag:tool/magnet/have-active_mk2_attract_exp] run tag @e[distance=..7,type=experience_orb] add smpmag.magnetCanAttract.exp
