...
execute as @e[type=minecraft:item,tag=dropRcpItemMagMk1_2] at @s if score #calculation_temp1 numeric matches -1 run function smpmag:tool/summon/item_magnet-mk1
