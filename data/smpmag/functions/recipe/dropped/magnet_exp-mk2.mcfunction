...
execute as @e[type=minecraft:item,tag=dropRcpExpMagMk2_3] at @s if score #calculation_temp1 numeric matches -1 run function smpmag:tool/summon/magnet_exp-mk2
